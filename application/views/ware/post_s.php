	...
	<div class="row-fluid">
		<div class="span12">
          ...
          <?php foreach($table as $val): ?>
            ...
            <td>
            <a href='<?= base_url('index.php/ware/return_s/'.$val['id']); ?>' class="btn btn-success btn-xs active" role="button">返回门店</a>
...
<input type='submit' class='batch' target="_self" name='submit' value='batch_post_s'>
</div>
