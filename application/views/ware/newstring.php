<!--查看更新串码信息-->
<?php echo form_open('ware/newstring_h')?>
    <fieldset>
    ...
    <!-- 新串码 -->
    <div class='col-md-12 pad10'>
      <label class="col-sm-1 text-center ">新串码</label>
      <div class="col-sm-4">
      <input type='text' class="input-xlarge  form-control" value='' name='newstring' placeholder="输入新的串码">
      </div>
    </div>  
    <!-- 换新串说明 -->
    <div class='col-md-12 pad10'>
      <label class="col-sm-1 text-center ">换串说明</label>
      <div class="col-sm-4">
      <input type='text' class="input-xlarge  form-control" value='' name='explain' placeholder="换新串码的理由">
      </div>
    </div>  
