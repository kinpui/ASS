<?php $this->load->view('header.php',array('title'=>'填写送修设备表'))?>
<body>
	<!-- HTML start-->
	<!--side start-->
	<div class="side">
  ...
  <h1 style='font-size:30px;' class='text-center'>送修表填写</h1>
  <hr>
  <!-- 生成form -->
  <?php echo form_open('warehouse/submit_form',array('class'=>'form-horizontal')); ?>
    <fieldset>
    <div class="form-group">
      <!-- text input 购机日期 -->
      <label class="col-sm-5 control-label" for="input01">购机日期</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <!-- Text input 客户名称-->
      <label class="col-sm-5 control-label" for="input01">客户名称</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <!-- Text input 客户电话-->
      <label class="col-sm-5 control-label" for="input01">客户电话</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <!-- Text input 品牌型号-->
      <label class="col-sm-5 control-label" for="input01">品牌型号</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <!-- Text input 数码串码-->
      <label class="col-sm-5 control-label" for="input01">数码串码</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <!-- Text input 外观描述-->
      <label class="col-sm-5 control-label" for="input01">外观描述:</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <!-- Text input TP & 显示屏 -->
      <label class="col-sm-5 control-label" for="input01">TP/显示屏</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      ...
      <label class="col-sm-5 control-label" for="input01">附带配件</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      ...
      <label class="col-sm-5 control-label">数码类型</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <!-- Select Basic 下拉选择颜色-->
      <label class="col-sm-5 control-label">颜 色: </label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <!-- Textarea 故障原因 -->
      <label class="col-sm-5 control-label">故障原因</label>
      <div class="col-sm-4">
        <div class="textarea">
